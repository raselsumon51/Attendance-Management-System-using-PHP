...
if (isset($_POST['submit'])) {
  //get the values from the form of index2.php
  $id = $_POST['cid'];
  $course = $_POST['cname'];
    ...
    <div class="slideshow-container">
      ...
      ?>
          <div class="mySlides fade">
            <img class="rounded mt-5 mx-auto d-block" onclick="myf('<?php echo $id ?>','<?php echo $course ?>','<?php echo $date ?>')" src="<?php echo "upload/" . $img_name ?>" width="400" height="300">
